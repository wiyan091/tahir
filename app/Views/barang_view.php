                                        ...
                                        <form action="<?= base_url('barang/edit/' . $barang['id']) ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jumlah" class="form-control" id="jumlah" value="<?= $barang['jumlah'] ?>" placeholder="Jumlah Barang" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="keterangan">Keterangan</label>
                                                    <input type="text" name="keterangan" class="form-control" id="keterangan" value="<?= $barang['keterangan'] ?>" placeholder="Keterangan" required>
                                                </div>
                                                <div class="form-group">
