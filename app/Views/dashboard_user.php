                    ...
                    <tbody id="tableData">
                        <?php foreach ($barangusers as $index => $baranguser) : ?>
                            <tr>
                                ...
                                <td><?php echo $baranguser['username'] ?></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <a href="generateuser-pdf" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Pdf</a>
                </div>
            </div>
        </div>
    </div>
