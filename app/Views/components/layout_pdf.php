...
<head>
    ...
    <title>- Atk Humas - <?php echo $hlm ?></title>
    <link rel="icon" type="image/png" href="<?php echo base_url('public/assets/img/favicon_custom.png') ?>">

    <!-- Custom fonts for this template-->
    <link href="<?php echo base_url()?>public/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="<?php echo base_url()?>public/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
